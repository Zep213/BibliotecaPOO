...
public class Biblioteca {
    ...
    public static void main(String[] args) {
        nome = "Biblioteca Umariense";
        endereco = "Centro, 156";

        System.out.println(CadastroDeLivros("java easy", "sgsefsfsdfsdf", 10));
        System.out.println(CadastroDeLivros("python hard", "dawffsfasf", 5));

        System.out.println(LocalizacaoDeTitulo("java easy"));
        System.out.println(LocalizacaoDeLivrosDoAutor("Herbert Schildt"));

        System.out.println(Emprestimo("java easy"));
        System.out.println(Entregar("java easy"));
        System.out.println(ExibirInformacao("java easy"));
    }
}
